                    ...
                    public void onAdLoaded(AppOpenAd ad) {
                        ...
                        if (!isSplash) {
                            ...
                            AppOpenManager.this.appResumeAd.setOnPaidEventListener(adValue -> {
                                ...
                                BBLLogEventManager.logPaidAdjustWithToken(adValue, ad.getAdUnitId(), BBLAdConfig.ADJUST_TOKEN_TIKTOK);
                            });
                ...
                new AppOpenAd.AppOpenAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull AppOpenAd appOpenAd) {
                        ...
                        appOpenAd.setOnPaidEventListener(adValue -> {
                            ...
                            BBLLogEventManager.logPaidAdjustWithToken(adValue, appOpenAd.getAdUnitId(), BBLAdConfig.ADJUST_TOKEN_TIKTOK);
                ...
                new InterstitialAdLoadCallback() {
                    ...
                    public void onAdLoaded(@NonNull InterstitialAd interstitialAd) {
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            ...
                            BBLLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), BBLAdConfig.ADJUST_TOKEN_TIKTOK);
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh1.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            BBLLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh1.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh2.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            BBLLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh2.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashHigh3.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            BBLLogEventManager.logClickAdsEvent(activity, mOpenSplashHigh3.getAdUnitId());
                            adCallback.onAdClicked();
        ...
        new Handler().postDelayed(() -> {
            mOpenSplashNormal.setFullScreenContentCallback(
                    new FullScreenContentCallback() {
                        ...
                        public void onAdClicked() {
                            super.onAdClicked();
                            BBLLogEventManager.logClickAdsEvent(activity, mOpenSplashNormal.getAdUnitId());
                            adCallback.onAdClicked();
