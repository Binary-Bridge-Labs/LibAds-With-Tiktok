...
public class Admob {
    private static final String TAG = "BBLStudio";
    ...
    public void onShowSplash(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterstitialSplash.setOnPaidEventListener(adValue -> {
            ...
            if (tokenAdjust != null) {
                BBLLogEventManager.logPaidAdjustWithToken(adValue, mInterstitialSplash.getAdUnitId(), tokenAdjust);
            }
                        ...
                        interstitialAd.setOnPaidEventListener(adValue -> {
                            BBLLogEventManager.logPaidAdImpression(context,
                                    ...
                                    interstitialAd.getResponseInfo()
                                            .getMediationAdapterClassName(), AdType.INTERSTITIAL);
                            if (tokenAdjust != null) {
                                BBLLogEventManager.logPaidAdjustWithToken(adValue, interstitialAd.getAdUnitId(), tokenAdjust);
                            }
        ...
        AdLoader adLoader = new AdLoader.Builder(context, id)
                .forNativeAd(nativeAd -> {
                    ...
                    nativeAd.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            BBLLogEventManager.logPaidAdjustWithToken(adValue, id, tokenAdjust);
                        }
    ...
    public void populateUnifiedNativeAdView(ApNativeAd apNativeAd, NativeAdView adView, AdCallback nativeCallBack) {
        NativeConfig nativeConfig = apNativeAd.getNativeConfig();
        ...
        try {
            ...
            bg.setBackgroundResource(R.drawable.bg_native_ads);
            bg.setBackgroundColor(Color.parseColor(nativeConfig.getBackgroundColor()));
...
//            drawable.setCornerRadius(8); // 8dp corner radius
            ...
            // Set background tint cho CTA button
            ...
            public void onAdLoaded(@NonNull RewardedAd rewardedAd) {
                ...
                Admob.this.rewardedAd.setOnPaidEventListener(adValue -> {
                    BBLLogEventManager.logPaidAdImpression(context,
                            ...
                            , AdType.REWARDED);
                    if (tokenAdjust != null) {
                        BBLLogEventManager.logPaidAdjustWithToken(adValue, rewardedAd.getAdUnitId(), tokenAdjust);
                    }
            ...
            public void onInterstitialLoad(@Nullable InterstitialAd interstitialAd) {
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh1.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            BBLLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh1.getAdUnitId(), tokenAdjust);
                        }
                    });
    ...
    private void onShowSplashHigh1(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterSplashHigh1.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                BBLLogEventManager.logClickAdsEvent(context, mInterSplashHigh1.getAdUnitId());
            }
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh2.setOnPaidEventListener(new OnPaidEventListener() {
                        ...
                        public void onPaidEvent(@NonNull AdValue adValue) {
                            ...
                            if (tokenAdjust != null) {
                                BBLLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh2.getAdUnitId(), tokenAdjust);
                            }
                        }
                    });
    ...
    private void onShowSplashHigh2(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterSplashHigh2.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                BBLLogEventManager.logClickAdsEvent(context, mInterSplashHigh2.getAdUnitId());
            }
            ...
            public void onInterstitialLoad(@Nullable InterstitialAd interstitialAd) {
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashHigh3.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            BBLLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashHigh3.getAdUnitId(), tokenAdjust);
                        }
                    });
    ...
    private void onShowSplashHigh3(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterSplashHigh3.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                BBLLogEventManager.logClickAdsEvent(context, mInterSplashHigh3.getAdUnitId());
            }
            ...
            public void onInterstitialLoad(@Nullable InterstitialAd interstitialAd) {
                ...
                if (interstitialAd != null) {
                    ...
                    mInterSplashNormal.setOnPaidEventListener(adValue -> {
                        ...
                        if (tokenAdjust != null) {
                            BBLLogEventManager.logPaidAdjustWithToken(adValue, mInterSplashNormal.getAdUnitId(), tokenAdjust);
                        }
                    });
    ...
    public void onShowSplashNormal(AppCompatActivity activity, AdCallback adListener) {
        ...
        mInterSplashNormal.setFullScreenContentCallback(new FullScreenContentCallback() {
            ...
            public void onAdClicked() {
                ...
                if (disableAdResumeWhenClickAds)
                    AppOpenManager.getInstance().disableAdResumeByClickAction();
                BBLLogEventManager.logClickAdsEvent(context, mInterSplashNormal.getAdUnitId());
                if (adListener != null) {
                    adListener.onAdClicked();
                    adListener.onAdClicked(mInterSplashNormal.getAdUnitId(), mInterSplashNormal.getResponseInfo().getMediationAdapterClassName(), AdType.INTERSTITIAL);
                }
